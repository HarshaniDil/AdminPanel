...
@endif
    ...
    <form class="form-horizontal" method="POST" action="{{url('main/Department')}}">
    {{csrf_field() }}
    ...
    <div class="form-group">
        <div class ="col-sm-11">
        <input type="text" name="dep_short_name" class="form-control" placeholder="Department Short name" />
        </div>
